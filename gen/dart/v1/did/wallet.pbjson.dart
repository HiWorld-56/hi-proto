...
final $typed_data.Uint8List getWalletReqDescriptor = $convert.base64Decode(
    'CgxHZXRXYWxsZXRSZXESEAoDZGlkGAEgASgJUgNkaWQSEgoEdHlwZRgCIAEoBVIEdHlwZQ==');
...
final $typed_data.Uint8List getWalletRespDescriptor = $convert.base64Decode(
    ...
    'RsaXN0GjQKBFVuaXQSEgoEdHlwZRgBIAEoBVIEdHlwZRIYCgdhZGRyZXNzGAIgASgJUgdhZGRy'
    'ZXNz');
...
final $typed_data.Uint8List listAddressesReqDescriptor = $convert.base64Decode(
    ...
    '5Vbml0UgRsaXN0GiwKBFVuaXQSEAoDZGlkGAEgASgJUgNkaWQSEgoEdHlwZRgCIAEoBVIEdHlw'
    'ZQ==');
...
final $typed_data.Uint8List listAddressesRespDescriptor = $convert.base64Decode(
    ...
    'NwLlVuaXRSBGxpc3QaRgoEVW5pdBIQCgNkaWQYASABKAlSA2RpZBISCgR0eXBlGAIgASgFUgR0'
    'eXBlEhgKB2FkZHJlc3MYAyABKAlSB2FkZHJlc3M=');
...
final $typed_data.Uint8List listUsersAssetsReqDescriptor = $convert.base64Decode(
    'ChJMaXN0VXNlcnNBc3NldHNSZXESGgoIY3VycmVuY3kYASABKAlSCGN1cnJlbmN5EhwKAXAYAi'
    'ABKAsyDi5oaS5QYWdpbmF0aW9uUgFw');
...
const ListUsersAssetsResp$json = {
  ...
  '2': [
    {'1': 'total', '3': 1, '4': 1, '5': 3, '10': 'total'},
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.did.ListUsersAssetsResp.Unit',
      '10': 'list'
    },
  ],
...
final $typed_data.Uint8List listUsersAssetsRespDescriptor = $convert.base64Decode(
    'ChNMaXN0VXNlcnNBc3NldHNSZXNwEhQKBXRvdGFsGAEgASgDUgV0b3RhbBIxCgRsaXN0GAIgAy'
    'gLMh0uZGlkLkxpc3RVc2Vyc0Fzc2V0c1Jlc3AuVW5pdFIEbGlzdBo+CgRVbml0EhAKA2RpZBgB'
    'IAEoCVIDZGlkEhYKBmF2YXRhchgCIAEoCVIGYXZhdGFyEgwKAW4YAyABKAlSAW4=');
