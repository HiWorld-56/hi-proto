...
class LoginClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$1.LoginResp> verify(
    $0.Web3Data request, {
    $grpc.CallOptions? options,
  }) {
  ...
  static final _$refreshToken =
      $grpc.ClientMethod<$0.RefreshTokenReq, $0.Token>(
          ...
          $0.Token.fromBuffer);
  static final _$verify = $grpc.ClientMethod<$0.Web3Data, $1.LoginResp>(
      '/did.Login/Verify',
  ...
  static final _$getReqStatus = $grpc.ClientMethod<$0.ReqID, $1.ReqStatusResp>(
      '/did.Login/GetReqStatus',
      ($0.ReqID value) => value.writeToBuffer(),
      $1.ReqStatusResp.fromBuffer);
  static final _$notify = $grpc.ClientMethod<$0.Web3Data, $2.Empty>(
      '/did.Login/Notify',
      ($0.Web3Data value) => value.writeToBuffer(),
      $2.Empty.fromBuffer);
...
abstract class LoginServiceBase extends $grpc.Service {
  ...
  LoginServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.Web3Data, $1.LoginResp>(
        'Verify',
        verify_Pre,
        false,
        false,
    ...
    $addMethod($grpc.ServiceMethod<$0.Web3Data, $2.Empty>(
        'Notify',
        notify_Pre,
        false,
        false,
  ...
  $async.Future<$1.LoginResp> verify_Pre(
      $grpc.ServiceCall $call, $async.Future<$0.Web3Data> $request) async {
    return verify($call, await $request);
  }

  $async.Future<$1.LoginResp> verify(
  ...
  $async.Future<$2.Empty> notify($grpc.ServiceCall call, $0.Web3Data request);
