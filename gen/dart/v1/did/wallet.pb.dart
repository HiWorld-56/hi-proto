...
class ListAddressesResp_Unit extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'did')
    ..aOM<$3.Coin>(2, _omitFieldNames ? '' : 'coin', subBuilder: $3.Coin.create)
  ...
  @$pb.TagNumber(2)
  $3.Coin get coin => $_getN(1);
  @$pb.TagNumber(2)
  set coin($3.Coin value) => $_setField(2, value);
  @$pb.TagNumber(2)
  $core.bool hasCoin() => $_has(1);
  @$pb.TagNumber(2)
  void clearCoin() => $_clearField(2);
  @$pb.TagNumber(2)
  $3.Coin ensureCoin() => $_ensure(1);
...
class ListUsersAssetsResp extends $pb.GeneratedMessage {
  factory ListUsersAssetsResp({
    $core.Iterable<$core.String>? n,
  }) {
    final result = create();
    if (n != null) result.n.addAll(n);
    return result;
  }
  ...
  @$pb.TagNumber(2)
  $pb.PbList<$core.String> get n => $_getList(0);
}
