...
const (
	ApiKey_Create_FullMethodName = "/ai.ApiKey/Create"
	ApiKey_Edit_FullMethodName   = "/ai.ApiKey/Edit"
	ApiKey_List_FullMethodName   = "/ai.ApiKey/List"
	ApiKey_Delete_FullMethodName = "/ai.ApiKey/Delete"
)
...
type ApiKeyClient interface {
	...
	List(ctx context.Context, in *v1.Pagination, opts ...grpc.CallOption) (*ListApiKeyResp, error)
...
func (c *apiKeyClient) Create(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*CreateApiKeyResp, error) {
...
func (c *apiKeyClient) List(ctx context.Context, in *v1.Pagination, opts ...grpc.CallOption) (*ListApiKeyResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type ApiKeyServer interface {
	...
	List(context.Context, *v1.Pagination) (*ListApiKeyResp, error)
...
func (UnimplementedApiKeyServer) Create(context.Context, *emptypb.Empty) (*CreateApiKeyResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Create not implemented")
}
func (UnimplementedApiKeyServer) Edit(context.Context, *EditApiKeyReq) (*EditApiKeyResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Edit not implemented")
}
func (UnimplementedApiKeyServer) List(context.Context, *v1.Pagination) (*ListApiKeyResp, error) {
...
func _ApiKey_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiKeyServer).Create(ctx, req.(*emptypb.Empty))
	}
...
func _ApiKey_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiKeyServer).List(ctx, req.(*v1.Pagination))
	}
	return interceptor(ctx, in, info, handler)
}
