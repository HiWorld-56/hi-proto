...
const (
	Login_RefreshToken_FullMethodName = "/ai.Login/RefreshToken"
	Login_GenerateReq_FullMethodName  = "/ai.Login/GenerateReq"
	Login_GetReqStatus_FullMethodName = "/ai.Login/GetReqStatus"
)
