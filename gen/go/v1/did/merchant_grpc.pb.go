...
type MerchantClient interface {
	...
	GetProfile(ctx context.Context, in *v1.DID, opts ...grpc.CallOption) (*MerchantGetResp, error)
...
func (c *merchantClient) GetProfile(ctx context.Context, in *v1.DID, opts ...grpc.CallOption) (*MerchantGetResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(MerchantGetResp)
...
type MerchantServer interface {
	...
	GetProfile(context.Context, *v1.DID) (*MerchantGetResp, error)
...
func (UnimplementedMerchantServer) GetProfile(context.Context, *v1.DID) (*MerchantGetResp, error) {
